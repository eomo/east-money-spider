...
CREATE TABLE t_company_base_info(
        ...
        info_discloser VARCHAR(32) NOT NULL DEFAULT '' COMMENT '信息披露人',
        actual_controller VARCHAR(128) NOT NULL DEFAULT '' COMMENT '实际控制人',
        ultimate_controller VARCHAR(128) NOT NULL DEFAULT '' COMMENT '最终控制人',
        ...
        contacts VARCHAR(64) NOT NULL DEFAULT '' COMMENT '联系电话',
        fax VARCHAR(64) NOT NULL DEFAULT '' COMMENT '传真',
        website VARCHAR(64) NOT NULL DEFAULT '' COMMENT '公司网址',
        ...
        industry VARCHAR(64) NOT NULL DEFAULT '' COMMENT '证监会行业',
        UNIQUE KEY unique_index_code(`stock_code`)
)ENGINE=INNODB DEFAULT CHARSET=utf8mb4;