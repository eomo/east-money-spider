...
CREATE TABLE t_income_statement(
        id BIGINT PRIMARY KEY AUTO_INCREMENT,
        date_type BIGINT NOT NULL DEFAULT 0 COMMENT '日期类型',
        security_code BIGINT NOT NULL DEFAULT 0 COMMENT '股票代码',
        report_date BIGINT NOT NULL DEFAULT 0 COMMENT '日期',
        stock_type BIGINT NOT NULL DEFAULT 0 COMMENT '股票类型',
