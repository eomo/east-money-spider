...
CREATE TABLE t_company(
        ...
        office_address VARCHAR(64) NOT NULL DEFAULT '' COMMENT '办公地址',
        register_address VARCHAR(64) NOT NULL DEFAULT '' COMMENT '注册地址',
        capital VARCHAR(64) NOT NULL DEFAULT '' COMMENT '注册资本',
        business_regist VARCHAR(64) NOT NULL DEFAULT '' COMMENT '工商登记',
        oyee_num BIGINT NOT NULL DEFAULT 0 COMMENT '雇员人数',
        ger_num BIGINT NOT NULL DEFAULT 0 COMMENT '管理人员人数',
        law_office VARCHAR(64) NOT NULL DEFAULT '' COMMENT '律师事务所',
        accounting_firm VARCHAR(64) NOT NULL DEFAULT '' COMMENT '会计师事务所',
        brief VARCHAR(64) NOT NULL DEFAULT '' COMMENT '公司简介',
        business_scope VARCHAR(64) NOT NULL DEFAULT '' COMMENT '经营范围',
